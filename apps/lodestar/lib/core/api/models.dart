...
class Device {
  ...
  Device({required this.id, required this.name, required this.ed25519Pub, required this.x25519Pub, required this.createdAt});
...
class Circle {
  ...
  Circle({required this.id, required this.name, required this.color, required this.ownerDeviceId, required this.inviteCode, required this.createdAt});
...
class Envelope {
  ...
  Envelope({required this.id, required this.circleId, required this.deviceId, required this.kind, required this.ts, required this.nonce, required this.ciphertext});
...
class OpenEnvelope {
  ...
  OpenEnvelope({required this.sender, required this.kind, required this.ts, required this.data});
}
...
class Position {
  ...
  Position({required this.lat, required this.lng, required this.accuracy, required this.speed, required this.ts});

  factory Position.fromData(Map<String, dynamic> d, {required int ts}) => Position(
  ...
  Map<String, dynamic> toData() => {'lat': lat, 'lng': lng, 'acc': accuracy, 'speed': speed, 'ts': ts};
}
...
class Place {
  ...
  Place({required this.id, required this.name, required this.lat, required this.lng, required this.radiusM, required this.ts});
  ...
  Map<String, dynamic> toData() => {'id': id, 'name': name, 'lat': lat, 'lng': lng, 'radius_m': radiusM, 'ts': ts};
}